...
## Obsidian-Wissensmanagement (Notzien/)

### Verzeichnis
`Bachelor/Notzien (Obsidian)/` — lokaler Obsidian-Vault für tägliche Fortschrittsnotizen, Entscheidungen und Ressourcen.

### Zweck
Ergänzt Git-History mit menschenlesbarem Kontext:
- **Täglich:** Was wurde getan, welche Entscheidungen wurden getroffen, welche Probleme gelöst
- **Archiv:** PDFs, Literatur-Links, externe Ressourcen direkt im Vault ablegen
- **Architektur:** Diagramme, ADRs im Obsidian-Format (Mermaid-Support)
- **Features:** Eine Notiz pro Feature — Kriterien, Implementierungsdetails, Tests
...
│   ├── app.json
│   └── daily-notes.json             # Daily-Notes-Plugin
├── _templates/
│   ├── Daily Note.md                # Täglich-Vorlage
│   └── Feature Note.md              # Feature-Dokumentation
├── 00 - Projekt Übersicht.md        # Gesamtüberblick, Phase-Status
├── 01 - Architektur/                # Systemdiagramme, API-Docs
├── 02 - Daily Notes/                # YYYY-MM-DD.md pro Arbeitstag
├── 03 - Features/                   # Feature-Notizen
└── 04 - Ressourcen/                 # Links, PDF-Referenzen
```

### Konventionen
| Typ | Pfad | Wann anlegen |
|-----|------|-------------|
| Daily Note | `02 - Daily Notes/YYYY-MM-DD.md` | Täglich beim Start |
| Feature | `03 - Features/Feature-Name.md` | Beim Beginn eines neuen Features |
| Ressource | `04 - Ressourcen/` | Bei neuen Docs/PDFs |
| Architektur | `01 - Architektur/` | Bei Design-Entscheidungen |

### Claude Code Obsidian-Workflow
Am Ende jeder Arbeitssession:
1. Daily Note für heute anlegen (falls nicht vorhanden)
2. Fortschritt-Checkboxen aktualisieren
3. Getroffene Entscheidungen dokumentieren
4. Nächste Schritte eintragen
5. Implementierte Features mit Datei-Links verlinken

### Daily Note Template (Kurzform)
```markdown
---
date: YYYY-MM-DD
week: KW
...
## Entscheidungen
> _Heute getroffene Designentscheidungen und Begründungen_
