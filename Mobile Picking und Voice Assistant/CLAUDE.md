...
- Private Obsidian-Notizen liegen nicht mehr im Workspace.
- Wenn Architektur- oder Entscheidungskontext aus dem Vault gebraucht wird, nutze den ausgelagerten OneDrive-Pfad `C:\Users\endri\OneDrive\Bachelor-Auslagerung\2026-05-12\Notzien`.
- Obsidian ist optionaler Kontext, keine Completion-Pflicht fuer normale Code-Aenderungen.
- Fuer Code-Arbeit werden Notizen gezielt gelesen und mit `rg` durchsucht, nicht als kompletter Vault in den Kontext gezogen.
- Bei Architektur- oder Prozessentscheidungen kann die passende externe Daily Note aktualisiert werden, wenn der Vault verfuegbar ist.
...
- Lokale Claude-Hooks koennen diese Kriterien unterstuetzen, sind aber nicht Teil des bereinigten Workspaces.
