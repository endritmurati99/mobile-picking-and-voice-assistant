...
| Textbewertung bleibt `qwen2.5:7b` | `config.py:116` | Gleicher Prompt, warm: qwen 118 Token in 20,3 s mit Urteil; `gemma4:12b` 467 Token, kein Ende, nach 4 min abgebrochen | Textbewertung wird um Faktor 5 teurer, ohne Gewinn |
