...
Stand: 8. August 2026. Bewertet wurde die Reise gegen die bestehenden Ebenen,
PWA-Einstiegspunkte, FastAPI-Routen sowie die zentralen Session-, Picking-,
Cluster-, Intent-, Quality- und Outbox-Services.

| Kriterium | Punkte |
| --- | ---: |
| Durchgängigkeit vom Login bis zum Abschluss | 20/20 |
| Saubere Trennung von Normal-, Cluster- und optionalen Wegen | 20/20 |
| Übereinstimmung mit den belegten Fach- und Recovery-Pfaden | 20/20 |
| Verständlichkeit für Produktvorstellung und Bachelorarbeit | 20/20 |
| Ehrlichkeit, Verweise und technische Rückverfolgbarkeit | 20/20 |
| **Gesamt** | **100/100** |

Die 100/100 bewerten die Vollständigkeit und Genauigkeit dieser verbindenden
Darstellung. Sie bedeuten nicht, dass jede optionale Abhängigkeit immer
verfügbar ist oder dass die PWA offline buchen kann. Die technischen Grenzen
bleiben unverändert sichtbar und werden in Ebene 8 vertieft.

Belegt sind 161 erfolgreiche Backendtests für Session, Normalauftrag, Cluster,
Voice, Intent, Outbox, signierten Transport und Runtime-Lifecycle sowie 38
erfolgreiche PWA-API- und Voice-Tests. SVG-XML und Excalidraw-JSON wurden
syntaktisch validiert; die SVG-Exportfassung wurde außerdem im Browser
gerendert und visuell geprüft.

## Ebene 9 in sieben Sätzen

1. Mira meldet sich an und arbeitet in einer serverseitig gebundenen Sitzung.
2. Sie wählt Normal- oder Cluster-Picking als alternativen Hauptweg.
3. Im Cluster wird der Artikel einmal geprüft und danach jede Kartonzuordnung
   als eigene Fachaktion gebucht; getrackte Ware bleibt atomar.
4. FastAPI prüft; Odoo entscheidet und speichert.
5. Ein Problem wird erst durch bewusstes Absenden zur dauerhaften Meldung.
6. n8n und lokale KI verarbeiten Quality asynchron, ohne Odoo zu ersetzen.
7. Abschluss und Wiederanlauf orientieren sich immer am bestätigten Odoo-Stand.
